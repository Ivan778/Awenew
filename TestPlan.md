...
Этот вариант использования необходимо протестировать на:
1. Точность определения местоположения пользователя

### Низкий заряд аккумулятора на устойтсве
Этот вариант использования необходимо протестировать на:
1. Способность приложения определять геокоординаты при низком заряде аккумулятора
...
1. запустить приложение (первый экран по умолчанию - экран просмотра погоды и местоположения);
2. ожидать появление геокоординат
